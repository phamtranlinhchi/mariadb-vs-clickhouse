...
| **Alert History - Host**<br />Tables:<br />`icinga_statehistory`<br />`icinga_hostgroup_members`<br />`icinga_hostgroups`<br />`icinga_objects`<br />(19,349 rows) | `alias` in ('DBB_HPG', 'HNI') & `state_time` in 1 year<br />(1070 rows) | 0.193s     | **0.102s** |
